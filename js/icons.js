...
(function (DL) {
  ...
  var PATHS = {
    ...
    // 筋トレ：ダンベル。小さくしても軸とプレートが見分けられる形にする
    dumbbell: '<path d="M2.5 9.5h2.5v5H2.5zM19 9.5h2.5v5H19z"/>'
      + '<path d="M5 7.5h3v9H5zM16 7.5h3v9h-3z"/><path d="M8 12h8"/>',
    // 稲妻。角は落とさず、ダンベルと同じ角ばった調子にそろえる
    bolt: '<path d="M13.6 2.2 6.2 13.6h4.6L10.2 21.8 17.8 10.4h-4.6z"/>',
    // 売上：軸と棒グラフ
    ...
    // 取引先：名刺と担当者
    mail: '<path d="M3.5 5.5h17v13h-17z"/><path d="m3.5 6.5 8.5 6.2 8.5-6.2"/>',
    person: '<circle cx="12" cy="7.6" r="3.9"/>' +
      '<path d="M4.6 20.5v-1.7c0-2.7 3.3-4.3 7.4-4.3s7.4 1.6 7.4 4.3v1.7z"/>',
    lock: '<path d="M4.5 10.5h15v10h-15z"/><path d="M7.8 10.5V7.4a4.2 4.2 0 0 1 8.4 0v3.1"/>' +
      '<path d="M12 14.2v3"/>',
    faceid: '<path d="M3.5 8V3.5H8M16 3.5h4.5V8M20.5 16v4.5H16M8 20.5H3.5V16"/>' +
      '<path d="M9 9.6v1.8M15 9.6v1.8"/><path d="M12 9.6v3.6h-1.2"/>' +
    ...
    // 送る：紙ヒコーキ。折り目の線を1本入れて、三角に見えないようにする
    send: '<path d="M21 3 3 10.5l7.5 3L13.5 21 21 3Z"/><path d="M10.5 13.5 21 3"/>',
    ...
    /* 星。料理の評価に使う。付けたぶんは CSS で塗りつぶす（.mn-star.on） */
    star: '<path d="M12 3.2 14.7 9l6.3.8-4.6 4.3 1.2 6.2L12 17.4 6.4 20.3l1.2-6.2L3 9.8 9.3 9z"/>',
    // ひらめき：豆電球。他と揃えて角は落とさず、灯りの線を3本添える
    // ひらめき：豆電球。歯車や虫めがねと同じくらいの大きさに見えるよう、
    // 灯りの線を外まで伸ばして 24 の枠いっぱいに広げている
    idea: '<path d="M7.8 14.5A5.9 5.9 0 1 1 16.2 14.5L14.9 17H9.1z"/>' +
          '<path d="M9.4 19.3h5.2"/><path d="M10.4 21.6h3.2"/>' +
          '<path d="M12 1.2v2.6M3.0 4.8 6.0 6.6M21.0 4.8 18.0 6.6"/>',
    ...
    /* 部屋の予約を取り込む。部屋（戸）に、外から矢印が入っていく形 */
    roomIn: '<path d="M13 3.5h7.5v17H13"/><path d="M17.4 12.4v0.8"/><path d="M3.5 12h7.6"/><path d="M8 8.5 11.5 12 8 15.5"/>',
    ...
    /* 天気（Open-Meteo の記号に合わせた9種）。
       ...
       動かすところには印（wx-rays / wx-cloud / wx-drop など）を付けてある。
       どう動かすかは assets/style.css の側。しずくは1本ずつ落とすので、
       まとめて1本の path にせず、分けて並べてある */
    wSun: '<g class="wx-rays">'
        ...
        + '</g><circle class="wx-core" cx="12" cy="12" r="4.6"/>',
    wSunCloud: '<g class="wx-rays sm">'
             + '<path d="M8.4 1.4v1.8M2.4 7.4h1.8M4.2 3.2 5.4 4.4M12.6 3.2 11.4 4.4"/></g>'
             + '<circle class="wx-core sm" cx="8.4" cy="7.4" r="3.2"/>'
             + '<path class="wx-cloud" d="M9.8 21h8.4a3.3 3.3 0 0 0 .4-6.6 4.6 4.6 0 0 0-8.8-.9 3.3 3.3 0 0 0-.4 7.5z"/>',
    wCloud2: '<path class="wx-cloud" d="M6.6 18.5h10.2a3.9 3.9 0 0 0 .5-7.8 5.4 5.4 0 0 0-10.4-1.1 3.9 3.9 0 0 0-.3 8.9z"/>',
    wFog: '<path class="wx-cloud" d="M6.6 15.5h10.2a3.9 3.9 0 0 0 .5-7.8 5.4 5.4 0 0 0-10.4-1.1 3.9 3.9 0 0 0-.3 8.9z"/>' +
          '<path class="wx-fog f1" d="M5 18.6h14"/><path class="wx-fog f2" d="M7.4 21.6h9.2"/>',
    wDrizzle: '<path class="wx-cloud" d="M6.6 15.5h10.2a3.9 3.9 0 0 0 .5-7.8 5.4 5.4 0 0 0-10.4-1.1 3.9 3.9 0 0 0-.3 8.9z"/>' +
              '<path class="wx-drop d1" d="M9.2 18.4v1.8"/>' +
              '<path class="wx-drop d2" d="M12 19.4v1.8"/>' +
              '<path class="wx-drop d3" d="M14.8 18.4v1.8"/>',
    wRain: '<path class="wx-cloud" d="M6.6 15.5h10.2a3.9 3.9 0 0 0 .5-7.8 5.4 5.4 0 0 0-10.4-1.1 3.9 3.9 0 0 0-.3 8.9z"/>' +
           '<path class="wx-drop d1" d="M8.6 18.2v3.4"/>' +
           '<path class="wx-drop d2" d="M12 18.2v3.4"/>' +
           '<path class="wx-drop d3" d="M15.4 18.2v3.4"/>',
    wShower: '<path class="wx-cloud" d="M6.6 15.5h10.2a3.9 3.9 0 0 0 .5-7.8 5.4 5.4 0 0 0-10.4-1.1 3.9 3.9 0 0 0-.3 8.9z"/>' +
             '<path class="wx-drop slant d1" d="M9.6 18.2 7.8 21.8"/>' +
             '<path class="wx-drop slant d2" d="M13 18.2l-1.8 3.6"/>' +
             '<path class="wx-drop slant d3" d="M16.4 18.2l-1.8 3.6"/>',
    wSnow: '<path class="wx-cloud" d="M6.6 15.5h10.2a3.9 3.9 0 0 0 .5-7.8 5.4 5.4 0 0 0-10.4-1.1 3.9 3.9 0 0 0-.3 8.9z"/>' +
           '<path class="wx-flake f1" d="M8.1 18.4h1.7v1.7H8.1z" fill="currentColor" stroke="none"/>' +
           '<path class="wx-flake f2" d="M14.2 18.4h1.7v1.7h-1.7z" fill="currentColor" stroke="none"/>' +
           '<path class="wx-flake f3" d="M11.15 20.7h1.7v1.7h-1.7z" fill="currentColor" stroke="none"/>',
    wThunder: '<path class="wx-cloud" d="M6.6 15.5h10.2a3.9 3.9 0 0 0 .5-7.8 5.4 5.4 0 0 0-10.4-1.1 3.9 3.9 0 0 0-.3 8.9z"/>' +
              '<path class="wx-bolt" d="M13.4 17.2 9.8 21h2.9l-1.3 2.4"/>',
    // 夜の晴れ（現在の天気に使う）
    wMoon: '<path class="wx-moon" d="M19.8 15.2A8.4 8.4 0 0 1 8.8 4.2 8.4 8.4 0 1 0 19.8 15.2z"/>',
    wMoonCloud: '<path class="wx-moon sm" d="M12.4 9.2A5 5 0 0 1 6 2.8 5 5 0 1 0 12.4 9.2z"/>' +
                '<path class="wx-cloud" d="M9.8 21h8.4a3.3 3.3 0 0 0 .4-6.6 4.6 4.6 0 0 0-8.8-.9 3.3 3.3 0 0 0-.4 7.5z"/>',
    // 地点が未設定・取得できなかったとき
