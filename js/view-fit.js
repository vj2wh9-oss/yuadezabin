  ...
  function importSheet() {
    ...
    function shortcutCard() {
      ...
      var traps = [
        ...
        '{"error":"no_weight"}（&kg= のうしろが空）… ヘルスケアから体重が取れていません。'
          + '設定 App →「ヘルスケア」→「データアクセスとデバイス」→「ショートカット」で'
          + '体重の読み出しがオンか、ヘルスケアに体重が入っているかを見てください',
        '{"error":"no_weight"}（&kg= が無い）… 【テキスト】が「送り先＋値」に、'
          + '【URLの内容を取得】の URL が変数「テキスト」になっているかを見てください',
        '数字が来ているか確かめたい … 手順4の下に【クイックルック】を足して ▶ を押す。'
          + '空なら、ヘルスケア側の問題です',
