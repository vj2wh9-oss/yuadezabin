...
var ASSETS = [
  ...
  './js/view-detail.js', './js/view-pages.js', './js/view-doc.js', './js/view-sales.js', './js/view-books.js', './js/view-receipt.js', './js/view-files.js', './js/view-stock.js', './js/view-onsite.js', './js/view-orders.js', './js/view-crm.js', './js/view-search.js', './js/view-settings.js', './js/app.js',
