...
var ASSETS = [
  ...
  './js/util.js', './js/icons.js', './js/db.js', './js/store.js', './js/schedule.js', './js/events.js', './js/holidays.js', './js/printing.js', './js/notify.js', './js/search.js', './js/documents.js', './js/fanbox.js', './js/roomreserve.js', './js/crm.js', './js/orders.js', './js/weather.js', './js/fit.js', './js/daylog.js', './js/timeblocks.js', './js/expenses.js', './js/stock.js', './js/crop.js', './js/ocr.js', './js/sync.js', './js/backup.js', './js/zip.js', './js/files.js', './js/receipt.js', './js/memosend.js', './js/docpdf.js', './js/menu.js', './js/card.js', './js/advice.js', './js/bank.js', './js/ui.js', './js/forms.js', './js/kitchen.js', './js/plot.js', './js/lock.js',
  './js/view-home.js', './js/view-calendar.js', './js/view-events.js', './js/view-daylog.js', './js/view-time.js', './js/view-projects.js', './js/view-ticket.js',
  './js/view-detail.js', './js/view-pages.js', './js/view-fit.js', './js/view-doc.js', './js/view-sales.js', './js/view-books.js', './js/view-receipt.js', './js/view-files.js', './js/view-stock.js', './js/view-onsite.js', './js/view-orders.js', './js/view-crm.js', './js/view-lock.js', './js/view-search.js', './js/view-settings.js', './js/app.js',
