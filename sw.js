...
var ASSETS = [
  ...
  './js/util.js', './js/icons.js', './js/db.js', './js/store.js', './js/schedule.js', './js/documents.js', './js/fanbox.js', './js/expenses.js', './js/sync.js', './js/zip.js', './js/files.js', './js/ui.js', './js/forms.js',
