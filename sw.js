...
var ASSETS = [
  ...
  './js/util.js', './js/icons.js', './js/db.js', './js/store.js', './js/schedule.js', './js/documents.js', './js/fanbox.js', './js/sync.js', './js/zip.js', './js/files.js', './js/ui.js', './js/forms.js',
  './js/view-home.js', './js/view-calendar.js', './js/view-projects.js',
  './js/view-detail.js', './js/view-doc.js', './js/view-sales.js', './js/view-files.js', './js/view-settings.js', './js/app.js'
];
