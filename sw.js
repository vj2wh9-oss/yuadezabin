...
var ASSETS = [
  ...
  './js/util.js', './js/icons.js', './js/db.js', './js/store.js', './js/schedule.js', './js/events.js', './js/notify.js', './js/search.js', './js/documents.js', './js/fanbox.js', './js/expenses.js', './js/stock.js', './js/ocr.js', './js/sync.js', './js/zip.js', './js/files.js', './js/ui.js', './js/forms.js',
  './js/view-home.js', './js/view-calendar.js', './js/view-events.js', './js/view-projects.js',
  './js/view-detail.js', './js/view-doc.js', './js/view-sales.js', './js/view-books.js', './js/view-files.js', './js/view-stock.js', './js/view-search.js', './js/view-settings.js', './js/app.js'
];
