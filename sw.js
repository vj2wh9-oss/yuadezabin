...
var ASSETS = [
  ...
  './js/util.js', './js/icons.js', './js/db.js', './js/store.js', './js/schedule.js', './js/events.js', './js/notify.js', './js/search.js', './js/documents.js', './js/fanbox.js', './js/weather.js', './js/daylog.js', './js/expenses.js', './js/stock.js', './js/ocr.js', './js/sync.js', './js/zip.js', './js/files.js', './js/ui.js', './js/forms.js',
